...
public class RxErrorHandlingCallAdapterFactory extends CallAdapter.Factory {
    ...
    private static class RxCallAdapterWrapper implements CallAdapter<Observable<?>, Object> {
        ...
        public Observable<?> adapt(@NonNull Call call) {
            return ((Observable) wrapped.adapt(call)).onErrorResumeNext(new Function() {
                @Override
                public Object apply(Object throwable) throws Exception {
                    return Observable.error(RxCallAdapterWrapper.this.asRetrofitException((Throwable) throwable));
                }
            });
        }
